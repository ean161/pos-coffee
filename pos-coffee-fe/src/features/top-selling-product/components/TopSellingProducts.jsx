                                ...
                                <tr key={index} className="group hover:bg-[#fcf8f2] transition-all duration-200">
                                    <td className="px-6 py-4 text-center">
                                            <span className={`inline-flex items-center justify-center h-6 w-6 rounded-lg text-xs font-black border shadow-sm
                                                ${index === 0 ? 'bg-[#26170f] text-[#f7f0e9] border-[#26170f]' : ''}
                                                ${index === 1 ? 'bg-[#4a3728] text-[#f7f0e9] border-[#4a3728]' : ''}
                                                ${index === 2 ? 'bg-[#a27b5c] text-white border-[#a27b5c]' : ''}
                                                ${index > 2 ? 'bg-stone-50 text-stone-500 border-stone-200' : ''}
                                            `}>
                                                {index + 1}
                                            </span>
                                    </td>
